...
Ext.define("AM.config.AppConfig", {
  statics: {
    MOCK_DATA_ENV: "MOCK_DATA_ENV",
    PRODUCTION_ENV: "PRODUCTION_ENV",
    COOKIES: Ext.create('Ext.state.CookieProvider'),
    MASK: null,
    CODE_MIRROR_ADD: null,
    CODE_MIRROR_EDIT: null,
    CODE_MIRROR_LIST: null,
    APP_LOAD_STATUS: false,
    CURRENT_EDITOR: null
  },
  config: {
    environment: null,
  ...
  */
  ...
  constructor: function(cfg) {
    if ((cfg != null ? cfg.environment : void 0) && (AM.config.AppConfig[cfg.environment] != null)) {
      return this.setEnvironment(AM.config.AppConfig[cfg.environment]);
    } else {
      return this.setEnvironment(AM.config.AppConfig.PRODUCTION_ENV);
    }
  },
  /**
