        ...
        function updatePreviewAdd() {
            ...
            Ext.Ajax.request({
                ...
                success: function (response, opts) {
                    ...
                    preview.open();
                    preview.write('<iframe width="100%" height="600px" src="source generated/Temp/test/indexAdd' + AM.config.AppConfig.COOKIES.get('TableName') + '.html"></iframe>');
                    preview.close();
                },
        ...
        function updatePreviewEdit() {
            ...
            Ext.Ajax.request({
                ...
                success: function (response, opts) {
                    ...
                    var preview = previewFrame.contentDocument || previewFrame.contentWindow.document;
                    preview.open();
                    preview.write('<iframe width="100%" height="600px" src="source generated/Temp/test/indexEdit' + AM.config.AppConfig.COOKIES.get('TableName') + '.html"></iframe>');
                    preview.close();
                },
                failure: function (response, opts) {
                    AM.config.AppConfig.MASK.hide();
        ...
        function updatePreviewList() {
            ...
            Ext.Ajax.request({
                ...
                success: function (response, opts) {
                    ...
                    var preview = previewFrame.contentDocument || previewFrame.contentWindow.document;
                    preview.open();
                    preview.write('<iframe width="100%" height="600px" src="source generated/Temp/test/indexList' + AM.config.AppConfig.COOKIES.get('TableName') + '.html"></iframe>');
                    preview.close();
                },
                failure: function (response, opts) {
                    AM.config.AppConfig.MASK.hide();
